...
const SVGComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    style={{
      enableBackground: "new 0 0 399.141 399.141",
    }}
    xmlSpace="preserve"
    {...props}
  >
